...
namespace Wechat.Task.App.MessageListeners
{
    ...
    /// 发起添加好友验证
    /// </summary>
    public class AddFriendRequestListener : MessageListenerConcurrentlyBase<AddFriend>
    {
        private DefaultMQProducer producer = RocketMqHelper.CreateDefaultMQProducer("WECHAT_ADD_FRIEND_REQUEST_WATCH_PG");
        protected override void Invoke(org.apache.rocketmq.common.message.MessageClientExt messageClientExt, AddFriend obj)
        {
            ...
            try
            {
                ...
                Message message = new Message("WECHAT_ADD_FRIEND_REQUEST_WATCH_TOPIC", buffer);
